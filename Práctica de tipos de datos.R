...
hist(AMZN_2014, freq = FALSE, col="yellow", border="blue",main= "Densidades de los Precios AMZN en 2014", xlab = "Precios Cierre")
lines(density(AMZN_2014), lwd = 2, col = 'red')
hist(AMZN_2020, freq = FALSE, col="blue", border="blue",main= "Densidades de los Precios AMZN en 2020", xlab = "Precios Cierre")
